...
import (
	context "context"
	oidc "echo-starter/internal/services/oidc"
	reflect "reflect"

	oidc0 "github.com/coreos/go-oidc/v3/oidc"
...
func (m *MockIOIDCAuthenticator) ValidateJWTAccessToken(arg0 string) (*oidc.AccessToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateJWTAccessToken", arg0)
	ret0, _ := ret[0].(*oidc.AccessToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIOIDCAuthenticator) VerifyIDToken(arg0 context.Context, arg1 *oauth2.Token) (*oidc0.IDToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyIDToken", arg0, arg1)
	ret0, _ := ret[0].(*oidc0.IDToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
